      ...
      <div className='flex flex-col gap-4 m-5 min-w-[800px]'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          <div className='flex items-center gap-2 mt-1 text-gray-600'>
            ...
            <button className='py-0.5 px-2 border text-xs rounded-full border-primary'>{profileData.experience}</button>
          </div>
          ...
          {
            isEdit
              ? <button onClick={updateProfile} className='px-4 py-1 border border-primary text-sm rounded-full mt-5 hover:bg-primary hover:text-white transition-all'>Update</button>
