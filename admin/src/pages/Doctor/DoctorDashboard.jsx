  ...
  return dashData && (
    <div className='m-5'>
      <div className='flex flex-wrap gap-3'>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded borde-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
        ...
        <div className="pt-4 border border-t-0">
          {dashData.latestAppointments.map((item, index) => (
            <div className="flex items-center px-6 py-3 hover:bg-gray-100" key={index}>
              <img
                className="rounded-full w-10 flex-shrink-0"
